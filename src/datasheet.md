...
Telegram, a messaging app that facilitates both user interactions in private and public groups and
...
Raw text via snowballing Telegram channels and domain experts.
